...
public class RegisterConfirmationEmail {
    ...
    public static final String SUBJECT = "Welcome to Learn Python!";
    public static final String MAIL_BODY = """
            ...
            <main>
              <section>
                <p>Dziękujemy za założenie nowego konta na serwisie Learn Python with us. Mamy nadzieję że razem z nami rozpoczniesz swoją przygodę z językiem Python i wypłyniesz na dotąd nieznane Ci wody.</p>
